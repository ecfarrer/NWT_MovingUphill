...
#files: edge_listsKSno4b,edge_listsKS32no2b edge_listsKS32pb edge_listsBEPc# fdr correction on all spearman pvalues, and subset to only positive spearman rhos 
...
#all are bacteria
tax_table(otufile16S)[which(rownames(tax_table(otufile16S))%in%statslo1$otu),]
